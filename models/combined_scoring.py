...
#     def __init__(self, current_scores_path, predicted_metrics_path, current_weight=0.6, predicted_weight=0.4, cache_dir="../models/cache/scalers"):
...
#         self.scaler_path = os.path.join(self.cache_dir, "combined_scaler.pkl")   
...
#         else:
#             predicted_avg[numerical_cols] = self.scaler.transform(predicted_avg[numerical_cols])
...
#         current_scores_path=os.path.join(script_dir, "../data/scored_company_data.csv"),
...
class CombinedScoringModel:
    def __init__(self, current_scores_path, predicted_metrics_path, current_weight=0.6, predicted_weight=0.4, cache_dir="models/cache/scalers"):
        ...
        self.scaler = MinMaxScaler()
        self.cache_dir = cache_dir
        self.scaler_path = os.path.join(cache_dir, "combined_scaler.pkl")
        self.sector_weights = CompanyScoringModel("data/dummy_company_data.csv").sector_weights
